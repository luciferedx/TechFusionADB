...
<body style="background:url(images/wallpaper.jpg);background-repeat:no-repeat;background-size;100% 100%">
<br><br><br><br><br><br>
<section class="form-container">
   ...
   <form action="" method="post" id="formregister">
      ...
      <input type="submit" value="register now" name="submit" class="btn" id="loginow" style="color:white">
