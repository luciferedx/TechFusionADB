...
<head>
   ...
   <title>TechFusionADMIN | Update Products </title>
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         <option disabled selected value="<?= $fetch_products['category']; ?>"><?= $fetch_products['category']; ?></option>
      ...
      <div class="flex-btn">
         ...
         <a href="admin_manageproducts.php" class="option-btn">Go Back</a>
      </div>
   </form>
   <?php
         }
